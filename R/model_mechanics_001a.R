#' Experimental He10 POMP model for UK measles
#'
#' This model lacks alpha, and amplitude does not kick in during the Christmas
#' break.
#'
...
model_mechanics_001a = function(
  ...
  pt <- pomp::parameter_trans(
    log = c("sigma","gamma","sigmaSE","psi","R0", "mu", "iota"),
    logit = c("cohort","amplitude", "rho"),
    barycentric = c("S_0","E_0","I_0","R_0")
  )

  paramnames = c("R0","mu","sigma","gamma","iota", "rho",
